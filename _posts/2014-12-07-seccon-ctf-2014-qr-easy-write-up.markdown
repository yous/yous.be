...
twitter_card:
    image: https://yous.be/images/2014/12/07/DSC01964_s.JPG
facebook:
    image: https://yous.be/images/2014/12/07/DSC01964_s.JPG
---
...
(via [wikipedia.org](https://commons.wikimedia.org/wiki/File:QR_Ver3_Codeword_Ordering.svg))
...
- [QR Code Tutorial](https://www.thonky.com/qr-code-tutorial/) by [Thonky](https://www.thonky.com/)
- [How to Read QR Symbols Without Your Mobile Telephone](https://www.ams.org/samplings/feature-column/fc-2013-02) by Bill Casselman
